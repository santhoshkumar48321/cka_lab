...
**Common mistake to avoid:** Using grep -i (case-insensitive) when the pattern is case-sensitive — always match the exact case of the log pattern specified.
**Further reading:** https://kubernetes.io/docs/concepts/cluster-administration/logging/
