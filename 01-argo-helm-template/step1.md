...
6. Install Argo CD by applying the no-CRDs manifest you rendered
7. Confirm the Argo CD deployments exist in the target namespace
...
# Task 7: Confirm deployments are created.
